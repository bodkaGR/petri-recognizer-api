...
class Transition:
    def __init__(
        ...
        self.box_points = cv2.boxPoints(((self.center.x, self.center.y), (self.width, self.height), angle))
    ...
    def from_contour(cls, contour: np.ndarray):
        ...
        width = min_area_rect[1][0] ## minAreaRect always returns width as the longer side
        height = min_area_rect[1][1] ## minAreaRect always returns height as the shorter side 
